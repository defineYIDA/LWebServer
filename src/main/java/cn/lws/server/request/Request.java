...
import cn.lws.server.servlet.base.RequestHandler;
import cn.lws.server.servlet.context.ServletContext;
import cn.lws.server.constant.CharConstant;
import cn.lws.server.constant.CharsetProperties;
import cn.lws.server.model.Cookie;
import cn.lws.server.model.HTTPSession;
import cn.lws.server.request.dispatcher.RequestDispatcher;
import cn.lws.server.request.dispatcher.impl.ApplicationRequestDispatcher;
import lombok.Data;
...
public class Request {
    ...
    public RequestDispatcher getRequestDispatcher(String url) {
        return new ApplicationRequestDispatcher(url);//请求转发
    }
